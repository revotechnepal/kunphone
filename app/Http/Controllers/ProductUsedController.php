...
class ProductUsedController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            {
                $data = ProductOutgoing::latest()->where('quantity', '>', 0)->where('condition', 'used')->get();   
            }
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($row){
                            $showurl = route('admin.productused.show', $row->id);
                            $editurl = route('admin.productused.edit', $row->id);
                            $deleteurl = route('admin.productused.destroy', $row->id);
        ...
        return view('backend.product_outgoing.used_phones.index');
    }
    ...
    public function create()
    {
        ...
        return view('backend.product_outgoing.used_phones.create', compact('vendors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.productused.index')->with('success', 'Product Added Successfully');
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.product_outgoing.used_phones.show', compact('productoutgoing', 'productimages', 'product'));
    }
    ...
    public function edit($id)
    {
        ...
        $vendors = Vendor::latest()->get();
        return view('backend.product_outgoing.used_phones.edit', compact('productoutgoing', 'product', 'vendors'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.productused.index')->with('success', 'Product Updated Successfully');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.productused.index')->with('success', 'Product Deleted Successfully');
    }
}
