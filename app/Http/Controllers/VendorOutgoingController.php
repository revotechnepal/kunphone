...
class VendorOutgoingController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($row){
                            $showurl = route('vendor.productoutgoing.show', $row->id);
                            $editurl = route('vendor.productoutgoing.edit', $row->id);
                            $deleteurl = route('vendor.productoutgoing.destroy', $row->id);
        ...
        return view('backend.vendorside.product_outgoing.index');
    }
    ...
    {
        return view('backend.vendorside.product_outgoing.create');
    }
            ...
            if($variantexists == 1){
                ...
                $exists = ProductOutgoing::where('product_id', $product->id)
                    ...
                    if($exists){
                        ...
                        return redirect()->route('vendor.productoutgoing.index')->with('success', 'Product Quantity Increased');
                    }
                    else{
                        $featured = '';
                        if ($request['featured'] == null) {
                        ...
                        return redirect()->route('vendor.productoutgoing.index')->with('success', 'Product Added Successfully');
                    }
            }
            else{
    ...
    public function show($id)
    {
        ...
        return view('backend.vendorside.product_outgoing.show', compact('productoutgoing', 'product'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.vendorside.product_outgoing.edit', compact('productoutgoing', 'product'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($product){
            ...
            if($variantexists == 1){
                ...
                return redirect()->route('vendor.productoutgoing.index')->with('success', 'Product Updated Successfully');
            }
            else{
                return redirect()->back()->with('error', 'No such variant exists');
            }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('vendor.productoutgoing.index')->with('success', 'Product Deleted Successfully');
    }
}
