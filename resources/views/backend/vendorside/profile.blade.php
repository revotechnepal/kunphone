				    ...
				    <div class="row">
				        <div class="col-md-6">
				            <div class="panel panel-headline">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Vendor Profile => {{$vendor->name}}</h3>
						...
						<div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <p>{{$vendor->address}}, {{$vendor->district}}</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="row mt-3 text-left">
                                <div class="col-md-12">
                                    <a href="{{route('vendor.vendoredit', $vendor->id)}}" class="btn btn-primary mt-5">Edit</a>
                                </div>
                            </div>
