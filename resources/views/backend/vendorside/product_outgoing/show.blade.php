...
<div class="main">
    ...
    <div class="main-content">
        <div class="container-fluid">
            <h2 class="mb-3"> {{$product->name}} ({{$productoutgoing->quantity}} available in stock) <a href="{{route('vendor.productoutgoing.edit', $productoutgoing->id)}}" class="btn btn-success btn-sm"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit </a> <a href="{{route('vendor.productoutgoing.index')}}" class="btn btn-primary btn-sm"> <i class="fa fa-eye" aria-hidden="true"></i> View All Outgoing Products</a></h2>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <p>{{$productoutgoing->quantity}} available.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <img src="{{Storage::disk('uploads')->url($product->modelimage)}}" alt="{{$product->name}}" style="max-height: 200px;">
                                </div>
                            </div>
