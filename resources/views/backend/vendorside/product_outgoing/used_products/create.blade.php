...
<div class="main">
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            @endif
            <h2 class="mb-3">Create Outgoing Product <a href="{{route('vendor.productused.index')}}" class="btn btn-primary btn-sm"> <i class="fa fa-eye" aria-hidden="true"></i> View All Products</a></h2>

            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-body">
                            <form action="{{route('vendor.productused.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('POST')
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="rom" class="form-control" value="{{@old('rom')}}" placeholder="Ex: 42 GB">
                                            @error('rom')
                                                <p class="text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="details" id="" class="form-control" cols="30" rows="10" placeholder="Any more details to know.."></textarea>
                                        </div>
                                    </div>
