...
<div class="main">
    ...
    <div class="main-content">
        <div class="container-fluid">
            <h2 class="mb-3">Edit Profile <a href="{{route('vendor.profile')}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> View Profile</a></h2>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-body">
                            <form action="{{route('vendor.vendorupdate', $vendor->id)}}" method="POST" class="bg-light p-3">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-12">
