...
<div class="main">
    ...
    <div class="main-content">
        <div class="container-fluid">
            <h2 class="mb-3"> {{$product->name}} <a href="{{route('admin.product.edit', $productstorage->id)}}" class="btn btn-success btn-sm"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit </a></h2>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <img src="{{Storage::disk('uploads')->url($product->modelimage)}}" alt="{{$product->name}}" style="max-height: 100px;">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <p>{{$product->productdesign->color}}</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
