...
<div class="main">
    ...
    <div class="main-content">
        <div class="container-fluid">
            <h2 class="mb-3"> {{$productincoming->product->name}} ({{$productincoming->ram}} / {{$productincoming->rom}})  <a href="{{route('admin.productincoming.index')}}" class="btn btn-primary btn-sm"> <i class="fa fa-eye" aria-hidden="true"></i> View Unapproved Products</a> <a href="{{route('admin.productincoming.approved')}}" class="btn btn-primary btn-sm"> <i class="fa fa-eye" aria-hidden="true"></i> View Approved Products</a></h2>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-7">
                                    ...
                                    <form action="{{route('admin.productincoming.update', $productincoming->id)}}" method="POST">
                                        @csrf
                                        @method('PUT')

                                        <div class="row mb-4">
                                            <div class="col-md-3">
                                                <p>Unapproved Price (Rs.):</p>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="finalprice" value="{{(60/100) * $productstorage->price}}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-9">
                                                @if ($productincoming->is_approved == 0)
                                                    <p>Not Approved</p>
                                                @elseif($productincoming->is_approved == 'no')
                                                    <p>Approved</p>
                                                @endif

                                                <button type="submit" class="btn btn-primary">Approve</button>
                                                <p style="color: red;">Note*: Change the unapproved price after discussion and approve the product.</p>
                                            </div>
                                        </div>
                                    </form>
                                </div>
