...
<div class="main">
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            @endif
            <h2 class="mb-3">Edit Outgoing Product <a href="{{route('admin.productoutgoing.index')}}" class="btn btn-primary btn-sm"> <i class="fa fa-eye" aria-hidden="true"></i> View All Products</a></h2>

            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-body">
                            <form action="{{route('admin.productoutgoing.update', $productoutgoing->id)}}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
