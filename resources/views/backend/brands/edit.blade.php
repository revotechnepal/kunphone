...
<div class="main">
    ...
    <div class="main-content">
        <div class="container-fluid">
            <h2 class="mb-3">Edit Brand => {{$brand->name}} <a href="{{route('admin.brand.index')}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> View Brands</a></h2>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-body">
                            <form action="{{route('admin.brand.update', $brand->id)}}" method="POST" class="bg-light p-3" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
