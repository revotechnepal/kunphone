      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread">Buy Used Phone</h1>
          </div>
        </div>
      </div>
    </div>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-8 col-lg-10 order-md-last">
    				...
    				<div class="row mt-5">
                        @if ($productoutgoing->count() == 0)
                            <h3 class="billing-heading">No Used products at the moment.</h3>
                        @elseif($productoutgoing->count()>0)
